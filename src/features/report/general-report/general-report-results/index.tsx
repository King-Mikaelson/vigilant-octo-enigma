...
const ReportTable = () => {
  const { generalReportFromDate, generalReportToDate } =
  ...
  return (
    <main className="singleReports__content">
      <div className="singleReports__content--header">
        <div className="flex">
          <h2 className="bold-heading">General Report</h2>
          <p>
...
const GeneralReportResults = () => {
  ...
  const [successText, setSuccessText] = useState<string>(
    "Report has been sent via email susccesssfully"
  );
  ...
  return (
    <>
      ...
      {selected === "whatsapp" && openWhatsapp ? (
        <WhatsappModal
      ...
      {openPrintModal ? (
        <PrintModal setOpenPrintModal={setOpenPrintModal} />
      ) : (
        " "
      )}
      {isModalOpen ? (
            ...
            <div className="print-wrapper">
              ...
              <div>
                ...
                >
                  ...
                  <option value="pdf" className="options">
                    Download as PDF
                  </option>
                  <option value="msWord" className="options">
                    Download as MS Word
                  </option>
                  <option value="email" className="options">
                    Share Via Email
                  </option>
                  <option value="whatsapp" className="options">
                    Share Via Whatsapp
                  </option>
                </select>
              </div>
