      ...
      <main className="main-container">
        <div className="sub-container">
          <div className="sub-header">
            ...
            <p>
              We’ll be taking a <span>4%</span> commission of your monthly
              sales. This way you don’t have to bother about a particular
              subscription amount every month, we take just <span>4%</span> of
              whatever you make monthly.
            </p>
          </div>
